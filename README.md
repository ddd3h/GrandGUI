...
初代バージョンはANCO-project2022に開発された地上局のテレメトリ監視用のGUIである。この [GroundSystem GUI Project](https://github.com/Akatoki-Saidai/GroundSystem_GUI_Project) から精神を引き継ぎ、より誰でも自由に簡単に利用できるシステムの開発を行ったものになります。 
    ...
    <tr>
        <td align="center">
            <a href="https://github.com/ddd3h">
                <img src="https://avatars.githubusercontent.com/u/40761694?v=4" width="80px;" alt="ddd3h"/>
                <br />
                <sub><b>ddd3h</b></sub>
            </a>
        </td>
