...
初代バージョンはANCO-project2022に開発された地上局のテレメトリ監視用のGUIである[GroundSystem GUI Project](https://github.com/Akatoki-Saidai/GroundSystem_GUI_Project) から精神を引き継ぎ、より誰でも自由に簡単に利用できるシステムの開発を行ったものになります。 
